...
export const SystemPromptHeader = styled.div`
  display: flex;
...
// Legacy alias
export const AgentHeader = SystemPromptHeader;

export const SystemPromptHeaderLeft = styled.div`
  display: flex;
  flex-direction: column;
...
// Legacy alias
export const AgentHeaderLeft = SystemPromptHeaderLeft;

export const SystemPromptTitle = styled.h1`
...
// Legacy alias
export const AgentTitle = SystemPromptTitle;

export const SystemPromptMeta = styled.div`
  display: flex;
  gap: ${({ theme }) => theme.spacing[4]};
  font-size: ${({ theme }) => theme.typography.textSm};
  color: ${({ theme }) => theme.colors.white50};
...
// Legacy alias
export const AgentMeta = SystemPromptMeta;
