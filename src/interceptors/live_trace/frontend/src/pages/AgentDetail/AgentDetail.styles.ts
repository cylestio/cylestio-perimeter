...
export const AgentHeaderInfo = styled.div`
  display: flex;
  flex-direction: column;
  gap: ${({ theme }) => theme.spacing[2]};
`;

export const AgentHeaderName = styled.h1`
...
export const AgentHeaderId = styled.span`
  font-family: ${({ theme }) => theme.typography.fontMono};
  font-size: 12px;
  color: ${({ theme }) => theme.colors.white50};
`;

export const AgentHeaderStats = styled.div`
  display: flex;
...
export const SystemPromptList = styled.div`
  display: flex;
  flex-direction: column;
  gap: ${({ theme }) => theme.spacing[2]};
`;

export const SystemPromptListItem = styled.a`
  display: flex;
  align-items: center;
  gap: ${({ theme }) => theme.spacing[3]};
...
export const SystemPromptIcon = styled.div`
  width: 32px;
  height: 32px;
  display: flex;
  align-items: center;
...
export const SystemPromptIdText = styled.span`
  font-family: ${({ theme }) => theme.typography.fontMono};
  font-size: 12px;
  color: ${({ theme }) => theme.colors.cyan};
`;
